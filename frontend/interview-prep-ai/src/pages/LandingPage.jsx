...
const LandingPage = () => {
  ...
  return (
    <>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
              ...
              <h1 className="text-5xl text-black font-medium mb-6 leading-tight">
                ...
                <span className="text-transparent bg-clip-text bg-linear-to-r from-[#ff9324] to-[#e99a4b] animate-text-shine font-semibold">
                  AI Powered
                </span>{" "}
                Learning
              </h1>
      ...
      <div className="w-full min-h-full relative z-10 mb-0">
        <div>
