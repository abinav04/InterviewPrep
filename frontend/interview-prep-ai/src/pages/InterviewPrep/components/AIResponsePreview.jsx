...
const AIResponsePreview = ({ content }) => {
  ...
  return (
    <div className="w-full">
      <div className="text-[14px] prose prose-slate dark:prose-invert max-w-none break-words overflow-wrap-anywhere">
        <ReactMarkDown
          ...
          components={{
            ...
            p({ children }) {
              return <p className="mb-4 leading-5 break-words">{children}</p>;
            },
            strong({ children }) {
