export const BASE_URL = "https://interviewprep-bihh.onrender.com";

export const API_PATHS = {
  AUTH: {
    REGISTER: "/api/users/register", // Signup
    LOGIN: "/api/users/login", // Authenticate user & return JWT token
    GET_PROFILE: "/api/users/profile", // Get logged-in user details
  },

  IMAGE: {
    UPLOAD_IMAGE: "/api/users/upload-image", // Upload profile picture
  },
